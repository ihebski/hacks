...
if [ "$chrome_installed_version" = "$chrome_current_version" ]; then
    ...
    wget --show-progress -q https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb -P /tmp && sudo dpkg -i /tmp/google-chrome-stable_current_amd64.deb
fi
